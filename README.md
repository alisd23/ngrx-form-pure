...
1. Create a project folder (you can call it `ngrx-form` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-ngrx-form.git
cd angular-ngrx-form
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-ngrx-form/archive/master.zip)
...
Use your editor to search the project for all instances of `ngrx-form` and change it
